...
zxse=(253.6*(10+69+140+10+10)+86.3*(60+72+35+90+60+60+140)+96.8*(43+25+43+60+43+78)+135.9*(63+24+63+57)+65.8*(63+45+129+63+58+48+63)+49.3*120)#总销售额的计算
pjsl=(10+60+43+63+63+120+72+69+35+140+90+24+45+25+60+129+10+43+63+60+63+60+58+140+48+43+57+10+63+78)/30#平均每日销售数量的计算
...
zh=1844#月销售量总和
print("您的总销售额为：",zxse)
print("您的平均每日销售数量为:",pjsl)
print("您的羽绒服的月销售占比为",'%.2f%%'%(yrf/zh*100))
print("您的牛仔裤的月销售占比为",'%.2f%%'%(nzk/zh*100))
print("您的风衣的月销售占比为",'%.2f%%'%(fy/zh*100))
print("您的皮草的月销售占比为",'%.2f%%'%(pc/zh*100))
print("您的衬衫的月销售占比为",'%.2f%%'%(cs/zh*100))
input("")